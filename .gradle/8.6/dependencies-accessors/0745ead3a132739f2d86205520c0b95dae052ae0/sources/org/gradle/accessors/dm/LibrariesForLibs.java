...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final PassportLibraryAccessors laccForPassportLibraryAccessors = new PassportLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>passport</b>
     */
    public PassportLibraryAccessors getPassport() {
        return laccForPassportLibraryAccessors;
    }
    ...
    public static class PassportLibraryAccessors extends SubDependencyFactory {

        public PassportLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>analyzer</b> with <b>org.jmrtd:jmrtd</b> coordinates and
         * with version reference <b>jmrtd</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getAnalyzer() {
            return create("passport.analyzer");
        }

        /**
         * Dependency provider for <b>scuba</b> with <b>net.sf.scuba:scuba-sc-android</b> coordinates and
         * with version reference <b>scuba</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getScuba() {
            return create("passport.scuba");
        }

        /**
         * Dependency provider for <b>spongycastle</b> with <b>com.madgag.spongycastle:prov</b> coordinates and
         * with version reference <b>spongycastle</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getSpongycastle() {
            return create("passport.spongycastle");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>composeNavigation</b> with value <b>2.8.0-beta02</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>jmrtd</b> with value <b>0.7.35</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getJmrtd() { return getVersion("jmrtd"); }
        ...
        /**
         * Version alias <b>scuba</b> with value <b>0.0.18</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getScuba() { return getVersion("scuba"); }
        ...
        /**
         * Version alias <b>spongycastle</b> with value <b>1.58.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getSpongycastle() { return getVersion("spongycastle"); }
    ...
    public static class BundleAccessors extends BundleFactory {
        ...
        /**
         * Dependency bundle provider for <b>camera</b> which contains the following dependencies:
         * <ul>
